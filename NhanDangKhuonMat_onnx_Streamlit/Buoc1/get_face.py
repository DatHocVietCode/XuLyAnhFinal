...
if __name__ == '__main__':
    ...
    # Đường dẫn thư mục lưu ảnh động (ví dụ lưu vào ../image/Tan)
    save_dir = os.path.abspath(os.path.join(current_file_dir, "../image/Tan"))
    ...
    while True:
        ...
        if key == ord('s') or key == ord('S'):
            ...
            if faces[1] is not None:
                ...
                # Đường dẫn file ảnh động
                file_name = os.path.join(save_dir, f"Tan{dem:04d}.bmp")
                print(file_name)
                print(face_align)
